...
// NO AFEGEIG RES NOU A NIVELL DE LÒGICA!
...
// ABANS D'ENTRAR A LA GESTIÓ AMB TRY/CATCH:
...
async function makeTwoRequests() {
  try {
    ...
    console.log(data2)
    // Si la petició es rebutja podem gestionar també què fer a la nostra funció Async amb un try/catch
  } catch (e) {
    console.log('ERROR!')
